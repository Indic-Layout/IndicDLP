...
# optimizer
optimizer = dict(
    _delete_=True, type='AdamW', lr=0.1, weight_decay=0.05,
...
log_config = dict(
    ...
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='RoDLA_finetuning',name='indic', entity='sahithi2002'))
    ]
)
